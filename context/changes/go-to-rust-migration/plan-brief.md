...
- **69 feature/integration rows:** 36 retained, 19 replaced, 1 preserve-data-only, 12 dropped, 1 awaiting review.
...
- All 1 feature and 1 defect Review rows are resolved before Rust implementation.
