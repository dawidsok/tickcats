...
- **68 feature/integration rows:** 24 retained, 10 replaced, 1 preserve-data-only, 7 dropped, 26 awaiting review.
...
| TUI creation | Four-field form | Retains kind, title, P0–P3, and `[to refine]` with current Feature/P2/to-refine defaults. |
...
- All 26 feature and 3 defect Review rows are resolved before Rust implementation.
